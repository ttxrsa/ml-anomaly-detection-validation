...
param_grid = {
    ...
    "contamination": ["auto", 0.01, 0.03, 0.05, 0.10],
    "threshold_percentile": [90, 91, 92, 93, 94, 95, 96, 97, 98, 99]
}
...
for (
    ...
    param_grid["threshold_percentile"]
):
...
print("MELHOR RESULTADO - ISOLATION FOREST")
